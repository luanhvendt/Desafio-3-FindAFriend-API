...
INSERT INTO "new_pet" ("about", "age", "createdAt", "deletedAt", "energy", "environment", "id", "independence", "name", "organization_id", "photos", "size", "updatedAt") SELECT "about", "age", "createdAt", "deletedAt", "energy", "environment", "id", "independence", "name", "organization_id", "photos", "size", "updatedAt" FROM "pet";
DROP TABLE "pet";
